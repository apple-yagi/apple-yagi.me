...
export const ZennIcon = (props: ComponentProps<"svg">) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 88.3 88.3" {...props}>
    ...
    />
    <path
      d="M55.33,77.57,74.77,46.35a1.43,1.43,0,0,0-1.23-2.2H59.47a1.54,1.54,0,0,0-1.32.7l-20,31.93a1.21,1.21,0,0,0,1.06,1.85H53.57A1.92,1.92,0,0,0,55.33,77.57Z"
      fill="#3ea8ff"
    />
  </svg>
);
